...
export default function AboutMe() {
  return (
    <div className="banner__info w-2xs">
      <div className="banner__info_categories flex items-center pb-2">
        ...
        <a target="_blank" href='https://www.linkedin.com/in/diego-garcía-934114262' className="pl-2" rel="noopener noreferrer">@diego-garcía</a>
      </div>
      <div className="banner__info_categories flex items-center pb-2">
        <div className="icon-content">
        ...
        <a target="_blank" href='https://github.com/DI3906' className="pl-2" rel="noopener noreferrer">DI3906</a>
      </div>
      <div className="banner__info_categories flex pb-2">
        <MapPin />
        <p className="pl-4">CDMX</p>
      </div>
    </div>
  );
}